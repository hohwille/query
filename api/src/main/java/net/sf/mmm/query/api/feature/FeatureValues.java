...
/**
 * {@link StatementFeature} for a {@link net.sf.mmm.query.api.statement.Statement} allowing a
 * {@link #value(PropertyPath, Object) VALUES clause}. For each invocation of
 * {@link #value(PropertyPath, Object) value(pI, vI)} a value binding is added so in the end the resulting SQL
 * fragment will be:
 *
 * <pre>
...
public abstract interface FeatureValues<SELF extends FeatureValues<SELF>> extends StatementFeature {
   ...
   *        {@ocde VALUES} keyword.
   * @param value the literal value to assign that will be added to the bracket after the {@ocde VALUES}
   *        keyword.
