...
/**
 * This is the interface for a query that is the {@link net.sf.mmm.query.api.statement.SelectStatement#query()
 * result} of a {@link net.sf.mmm.query.api.statement.SelectStatement}.<br/>
 * Besides {@link #execute() executing} the {@link Query} you can also reuse it as a sub-query in more complex
 * {@link net.sf.mmm.query.api.statement.Statement}s.
 *
