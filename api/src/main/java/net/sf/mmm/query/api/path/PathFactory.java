...
/**
 * This is the abstract interface for a factory to {@link #to(ReadableBooleanProperty) create} instances of
 * {@link Path} and its sub-types. An instance of {@link PathFactory} is either a {@link Path} itself or a
 * {@link PathRoot}.
 *
 * @author hohwille
 * @since 8.5.0
