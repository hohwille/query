...
/**
 * {@link StatementFeature} for a {@link net.sf.mmm.query.api.statement.Statement} allowing an
...
public abstract interface FeatureOrderBy<SELF extends FeatureOrderBy<SELF>> extends StatementFeature {
  ...
  /**
   * Adds the given {@link PropertyPath} to the {@code ORDER BY} clause using default {@link SortOrder} (what
   * should be {@link SortOrder#ASCENDING ascending}).
   *
