...
package net.sf.mmm.query.api.expression;
...
/**
 * An {@link Expression} or predicate that checks a value or {@link net.sf.mmm.property.api.ReadableProperty
 * property}.
 *
...
public interface Expression {
   ...
   * @return a new {@link Expression} combining this {@link Expression} with the given {@code Expression}s
   *         using the given {@link Conjunction}.
   */
   ...
   * @param terms the array of the {@link Expression}s to combine with this one.
   * @return a new {@link Expression} combining this {@link Expression} with the given {@code Expression}s
   *         using a {@link Conjunction#OR logical OR}.
   */
   ...
   * @param terms the array of the {@link Expression}s to combine with this one.
   * @return a new {@link Expression} combining this {@link Expression} with the given {@code Expression}s
   *         using a {@link Conjunction#AND logical AND}.
   */
  ...
  /**
   * @return {@code true} if this is a {@link net.sf.mmm.util.query.base.expression.ConstantExpression
   *         constant expression} that {@link #evaluate() evaluates} to a fixed result, {@code false}
   *         otherwise.
   */
  boolean isConstant();

  /**
   * @param formatter the {@link ExpressionFormatter} where to {@link ExpressionFormatter#append(CharSequence)
   *        append} this {@link Expression}.
   * @param bracketing the {@link Bracketing}.
   * @param resolveNegativeConjunctions {@code true} if {@link Conjunction#isNegation() negative}
   *        {@link Conjunction}s should be resolved via negation (e.g. {@code !(a OR b)} instead of
   *        {@code a NOR b}), {@code false} otherwise.
   */
