...
/**
 * {@link StatementFeature} for a {@link net.sf.mmm.query.api.statement.Statement} with support for #innerJoin
 * block.
 *
...
public abstract interface FeatureAndFrom<SELF extends FeatureAndFrom<SELF>> extends StatementFeature {
   ...
   *        {@link net.sf.mmm.query.api.statement.Statement#getAlias()}).
