...
import net.sf.mmm.query.api.Query;
import net.sf.mmm.query.api.SingleQuery;
import net.sf.mmm.util.exception.api.ObjectNotFoundException;

/**
 * A {@link FeatureFetch} is for a regular {@link net.sf.mmm.query.api.statement.SelectStatement} to fetch and
 * retrieve results.
 *
 * @see net.sf.mmm.query.api.statement.SelectStatement
 *
