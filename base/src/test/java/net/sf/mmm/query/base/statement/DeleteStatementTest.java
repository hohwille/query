...
import net.sf.mmm.query.base.statement.DeleteStatementTest.TestDeleteStatement;
...
public class DeleteStatementTest extends AbstractStatementTest<TestDeleteStatement<QueryTestPropertyBean>> {
  ...
  public static class TestDeleteStatement<E extends Bean> extends AbstractDeleteStatement<E, TestDeleteStatement<E>> {
