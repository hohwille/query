...
import net.sf.mmm.query.api.expression.Bracketing;
...
import net.sf.mmm.query.base.argument.ConstantArgument;
import net.sf.mmm.query.base.expression.SimpleExpressionFormatter;
