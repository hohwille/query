...
package net.sf.mmm.query.base.feature;
...
import net.sf.mmm.query.base.expression.Expressions;
import net.sf.mmm.query.base.statement.AbstractStatement;
import net.sf.mmm.query.base.statement.SqlBuilder;
...
public abstract class AbstractFeature implements StatementFeature, Comparable<AbstractFeature> {
  ...
  /**
   * @return the sort index used to define the order of the SQL fragments when building a statement from
   *         multiple features.
   */
