...
import net.sf.mmm.query.api.NumberQuery;
import net.sf.mmm.query.api.SingleQuery;
import net.sf.mmm.query.api.expression.Expression;
import net.sf.mmm.query.api.path.ComparablePath;
...
import net.sf.mmm.query.base.ListQueryImpl;
import net.sf.mmm.query.base.NumberQueryImpl;
import net.sf.mmm.query.base.QueryMode;
import net.sf.mmm.query.base.SingleQueryImpl;
import net.sf.mmm.query.base.feature.FeatureGroupByImpl;
import net.sf.mmm.query.base.feature.FeatureOrderByImpl;
 ...
 * @since 8.5.0
 */
public abstract class AbstractSelectStatement<E, SELF extends SelectStatement<E, SELF>, T> extends AbstractStatement<E, SELF>
    implements SelectStatement<E, SELF> {
   ...
   *        .
   */
  public AbstractSelectStatement(SqlDialect dialect, EntityAlias<?> alias, Function<T, E> mapper, PropertyPath<?>... paths) {
  ...
  /**
   * @return the {@link Function} to {@link Function#apply(Object) map} the original query results to the
   *         external result type. May be {@code null} for the identity function if {@literal <T>=<E>}.
   */
   ...
   *         {@link net.sf.mmm.query.api.statement.StatementFactory#selectFrom(EntityAlias, net.sf.mmm.property.api.path.PropertyPath...)
   *         tuple} or
   ...
   *         {@link net.sf.mmm.query.api.statement.StatementFactory#selectFrom(EntityAlias) regular
   *         select query}
   */
   ...
   * @param sql the SQL to execute.
   * @param mode the {@link QueryMode}.
   * @param offset the {@link net.sf.mmm.query.api.feature.FeaturePaging#offset(long) offset}.
   * @param limit the {@link net.sf.mmm.query.api.feature.FeaturePaging#limit(int) limit}.
   * @return the result of the SQL execution.
   */
