...
import net.sf.mmm.query.base.argument.AbstractListArgument;
 ...
 * @since 8.5.0
 */
public class ListPathImpl<E> extends CollectionPathImpl<List<E>, E> implements ListPath<E>, AbstractListArgument<E> {
