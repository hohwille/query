...
/**
 * This class represents an {@link Alias} used in a
 * {@link net.sf.mmm.query.api.statement.SqlDialect#from() FROM} block of an
 * {@link net.sf.mmm.query.base.statement.AbstractStatement SQL statement}.
 *
