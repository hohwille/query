...
import net.sf.mmm.query.api.argument.BooleanArgument;
import net.sf.mmm.query.api.argument.CollectionArgument;
import net.sf.mmm.query.api.argument.ComparableArgument;
import net.sf.mmm.query.api.argument.EntityBeanArgument;
import net.sf.mmm.query.api.argument.ListArgument;
import net.sf.mmm.query.api.argument.MapArgument;
import net.sf.mmm.query.api.argument.NumberArgument;
import net.sf.mmm.query.api.argument.SetArgument;
...
public final class Args {
   ...
   * @param <V> the generic type of the value.
   * @param value the value to use as parameter.
   * @return the {@link Argument#isConstant() constant} {@link ComparableArgument} for the given
   *         {@code value}.
   */
   ...
   * @param <V> the generic type of the value.
   * @param value the value to use as parameter.
   * @return the {@link Argument#isConstant() constant} {@link EntityBeanArgument} for the given
   *         {@code value}.
   */
   ...
   * @param value the value to use as parameter.
   * @return the {@link Argument#isConstant() constant} {@link CollectionArgument} for the given
   *         {@code value}.
   */
