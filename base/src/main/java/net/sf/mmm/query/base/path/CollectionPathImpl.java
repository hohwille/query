...
import net.sf.mmm.query.base.argument.AbstractCollectionArgument;
 ...
 * @since 8.5.0
 */
public class CollectionPathImpl<V extends Collection<E>, E> extends PathImpl<V> implements CollectionPath<V, E>, AbstractCollectionArgument<V, E> {
