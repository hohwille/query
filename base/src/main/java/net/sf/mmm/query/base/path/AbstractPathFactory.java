...
import net.sf.mmm.property.api.ReadableSetProperty;
...
import net.sf.mmm.property.api.math.ReadableNumberProperty;
import net.sf.mmm.property.api.util.ReadableListProperty;
import net.sf.mmm.property.api.util.ReadableMapProperty;
import net.sf.mmm.query.api.path.BooleanPath;
import net.sf.mmm.query.api.path.ListPath;
import net.sf.mmm.query.api.path.MapPath;
import net.sf.mmm.query.api.path.NumberPath;
import net.sf.mmm.query.api.path.Path;
import net.sf.mmm.query.api.path.PathFactory;
import net.sf.mmm.query.api.path.PathRoot;
import net.sf.mmm.query.api.path.SetPath;
import net.sf.mmm.query.api.path.StringPath;
