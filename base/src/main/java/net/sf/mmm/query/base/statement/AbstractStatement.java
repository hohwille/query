...
import net.sf.mmm.query.base.feature.AbstractFeature;
...
public abstract class AbstractStatement<E, SELF extends Statement<E, SELF>> implements Statement<E, SELF> {
  ...
  /**
   * @return {@code true} if this {@link Statement} supports {@link EntityAlias#getName() aliasing},
   *         {@code false} otherwise (if aliasing has to be omitted).
   */
   ...
   *         {@link Statement} this is {@link #getAlias()}.{@link EntityAlias#getEntityType() getType()} but
   *         e.g. for
   ...
   * @return the requested {@link AbstractFeature feature} or {@code null} if NOT yet {@link #feature(Class)
   *         created}.
   */
