...
import net.sf.mmm.query.base.argument.AbstractComparableArgument;
 ...
 * @since 8.5.0
 */
public class ComparablePathImpl<V extends Comparable<?>> extends PathImpl<V> implements ComparablePath<V>, AbstractComparableArgument<V> {
